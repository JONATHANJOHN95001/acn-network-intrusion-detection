...
Test size 0.2  |  Kernel PCA (rbf)  |  k-Nearest Neighbors  (reference sheet #13)

Note: taken in place of sheet #5 Elastic Net, which is a regressor and cannot classify.

Run on its own:

    python Test_0.2_DR_RBF_KNN.py

Writes Test_0.2_DR_RBF_KNN.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
