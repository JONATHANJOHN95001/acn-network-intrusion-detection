"""
Test_0.6_DR_POLY_QDA

Test size 0.6  |  Kernel PCA (poly)  |  Quadratic Discriminant Analysis  (reference sheet #17)
...
Run on its own:
    ...
    python Test_0.6_DR_POLY_QDA.py

Writes Test_0.6_DR_POLY_QDA.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
