...
Test size 0.2  |  Kernel PCA (sigmoid)  |  k-Nearest Neighbors  (reference sheet #13)

Note: taken in place of sheet #5 Elastic Net, which is a regressor and cannot classify.

Run on its own:

    python Test_0.2_DR_SIG_KNN.py

Writes Test_0.2_DR_SIG_KNN.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
