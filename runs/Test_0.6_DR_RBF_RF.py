...
Test size 0.6  |  Kernel PCA (rbf)  |  Random Forest  (reference sheet #7)

Run on its own:

    python Test_0.6_DR_RBF_RF.py

Writes Test_0.6_DR_RBF_RF.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
