...
Test size 0.2  |  Kernel PCA (rbf)  |  Quadratic Discriminant Analysis  (reference sheet #17)
...
Run on its own:
    ...
    python Test_0.2_DR_RBF_QDA.py

Writes Test_0.2_DR_RBF_QDA.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
