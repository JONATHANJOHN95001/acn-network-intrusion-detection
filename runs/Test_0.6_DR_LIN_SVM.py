...
Test size 0.6  |  Kernel PCA (linear)  |  Support Vector Machine  (reference sheet #15)

Run on its own:

    python Test_0.6_DR_LIN_SVM.py

Writes Test_0.6_DR_LIN_SVM.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
