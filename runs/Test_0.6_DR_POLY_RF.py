...
Test size 0.6  |  Kernel PCA (poly)  |  Random Forest  (reference sheet #7)

Run on its own:

    python Test_0.6_DR_POLY_RF.py

Writes Test_0.6_DR_POLY_RF.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
...
def main():
    ...
    ax.set_ylabel("True")
    ax.set_title(f"Test {TEST_SIZE}  |  Kernel PCA {KERNEL}  |  Random Forest\n"
