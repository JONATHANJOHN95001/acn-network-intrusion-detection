...
Test size 0.4  |  Kernel PCA (linear)  |  k-Nearest Neighbors  (reference sheet #13)

Note: taken in place of sheet #5 Elastic Net, which is a regressor and cannot classify.

Run on its own:

    python Test_0.4_DR_LIN_KNN.py

Writes Test_0.4_DR_LIN_KNN.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
