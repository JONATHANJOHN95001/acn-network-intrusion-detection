"""
Test_0.4_DR_POLY_KNN

Test size 0.4  |  Kernel PCA (poly)  |  k-Nearest Neighbors  (reference sheet #13)

Note: taken in place of sheet #5 Elastic Net, which is a regressor and cannot classify.

Run on its own:

    python Test_0.4_DR_POLY_KNN.py

Writes Test_0.4_DR_POLY_KNN.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
...
def main():
    ...
    ax.set_ylabel("True")
    ax.set_title(f"Test {TEST_SIZE}  |  Kernel PCA {KERNEL}  |  k-Nearest Neighbors\n"
    ...
    row = {"Test": TEST_SIZE, "DR": "POLY", "Clas": CLASSIFIER,
