...
Test size 0.2  |  Kernel PCA (poly)  |  Random Forest  (reference sheet #7)

Run on its own:

    python Test_0.2_DR_POLY_RF.py

Writes Test_0.2_DR_POLY_RF.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
