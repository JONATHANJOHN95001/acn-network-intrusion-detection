...
Test size 0.6  |  Kernel PCA (sigmoid)  |  Quadratic Discriminant Analysis  (reference sheet #17)
...
Run on its own:
    ...
    python Test_0.6_DR_SIG_QDA.py

Writes Test_0.6_DR_SIG_QDA.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
