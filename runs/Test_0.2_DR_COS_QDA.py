...
Test size 0.2  |  Kernel PCA (cosine)  |  Quadratic Discriminant Analysis  (reference sheet #17)
...
Run on its own:
    ...
    python Test_0.2_DR_COS_QDA.py

Writes Test_0.2_DR_COS_QDA.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
