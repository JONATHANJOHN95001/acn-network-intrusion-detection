...
Test size 0.2  |  Kernel PCA (cosine)  |  Support Vector Machine  (reference sheet #15)

Run on its own:

    python Test_0.2_DR_COS_SVM.py

Writes Test_0.2_DR_COS_SVM.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
