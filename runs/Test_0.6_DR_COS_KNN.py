...
Test size 0.6  |  Kernel PCA (cosine)  |  k-Nearest Neighbors  (reference sheet #13)

Note: taken in place of sheet #5 Elastic Net, which is a regressor and cannot classify.

Run on its own:

    python Test_0.6_DR_COS_KNN.py

Writes Test_0.6_DR_COS_KNN.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
