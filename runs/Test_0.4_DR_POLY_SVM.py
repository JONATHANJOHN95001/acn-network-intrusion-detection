"""
Test_0.4_DR_POLY_SVM

Test size 0.4  |  Kernel PCA (poly)  |  Support Vector Machine  (reference sheet #15)

Run on its own:

    python Test_0.4_DR_POLY_SVM.py

Writes Test_0.4_DR_POLY_SVM.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
