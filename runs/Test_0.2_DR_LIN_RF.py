...
Test size 0.2  |  Kernel PCA (linear)  |  Random Forest  (reference sheet #7)

Run on its own:

    python Test_0.2_DR_LIN_RF.py

Writes Test_0.2_DR_LIN_RF.jpg (confusion matrix) and appends one row to
results/75_runs.csv.
"""
